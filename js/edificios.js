function addEdificiosCapa() {
    ...
    map.addSource("edificios_source", {
        "type": "vector",
        "url": "mapbox://tianlillo.38hip8mx"  // mapbox://Nuestor ID Tileset
    ...
    "source-layer": "construcciones-3fxo0a", // Nuestro nombre Tileset
    "maxzoom": 21,
    "minzoom": 14,
    "filter": [">", "numberOfFl", 0],
    "paint": {
        ...
        "fill-extrusion-height": ["*", 4 , ["to-number", ["get", "numberOfFl"]]],
